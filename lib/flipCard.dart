...
class FlipCardState extends State<FlipCard> with SingleTickerProviderStateMixin{
	...
	void initState() {
		super.initState();
		_animationController = AnimationController(vsync: this, duration: Duration(milliseconds: widget.speed));
...
//		});
	...
	Widget build(BuildContext context) {
		final child = Stack(
			...
			children: <Widget>[
				_buildPanel(front: true),
				_buildPanel(front: false)
			],
		);
...
//			  ignoring: front ? !isForward : isForward,
//			  child: AnimationCard(
