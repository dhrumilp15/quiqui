...
class ImageHandler {
  ...
  Future<void> downloadImages() async {
    ...
    Map<String, dynamic> downloadJson =
        await _fetchDownloadUrl(this.urlPath, this.zipName);
  ...
  Future<Map<String, dynamic>> _fetchDownloadUrl(
  ...
  Future<void> _download(
      String githubUrl, String saveDirPath, String nameOfZip) async {
    Dio dio = new Dio();
  ...
  Future<void> unzip(String path, String zipName) async {
    ...
    String saveDirName =
        "$path/${zipName.substring(0, zipName.lastIndexOf('.zip'))}"; // Ex - dogs.zip, this will produce a dog/ folder for all the images
    // Decode the Zip file
